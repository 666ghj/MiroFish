...
// Start simulation - navigate immediately; the API call is made on the Process page
const startSimulation = () => {
  ...
  import('../store/pendingUpload.js').then(({ setPendingUpload }) => {
    ...
    // Immediately navigate to the Process page (using a special id to indicate a new project)
    router.push({
      name: 'Process',

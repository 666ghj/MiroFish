...
Used to persist project state on the server side, avoiding shipping large amounts of data
through the front-end across API calls.
"""
...
class ProjectManager:
    ...
    def _get_project_files_dir(cls, project_id: str) -> str:
        """Get a project's file storage directory"""
        return os.path.join(cls._get_project_dir(project_id), 'files')

    @classmethod
    def _get_project_text_path(cls, project_id: str) -> str:
        """Get the storage path of a project's extracted text"""

...
class SimulationIPCClient:
    ...
    def send_command(
        ...
        Raises:
            TimeoutError: When waiting for the response times out
        """
    ...
    def send_interview(
        ...
        Args:
            ...
            platform: Specific platform (optional)
                ...
                - None: For dual-platform simulations, interview both platforms simultaneously; for single-platform simulations, interview that platform
            timeout: Timeout

        Returns:
            IPCResponse, where the result field contains the interview result
        """
        args = {
            "agent_id": agent_id,
            "prompt": prompt

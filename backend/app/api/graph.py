...
Uses a project-context mechanism with state persisted on the server side.
"""
...
def reset_project(project_id: str):
    """
    Reset project state (used when rebuilding the graph)
    """
    project = ProjectManager.get_project(project_id)
...
def generate_ontology():
    ...
    Parameters:
        files: uploaded files (PDF/MD/TXT); multiple are allowed
...
def build_graph():
    ...
    try:
        ...
        # If force-rebuilding, reset the state

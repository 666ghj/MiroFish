...
def generate_report():
    ...
    try:
        ...
        # Generate the report_id ahead of time so it can be returned to the front-end immediately
        import uuid
        ...
        def run_generate():
            ...
            try:
                ...
                # Generate the report (passing the pre-generated report_id)
...
def download_report(report_id: str):
    ...
    try:
        ...
        if not os.path.exists(md_path):
            # If the MD file does not exist, generate a temporary one
            import tempfile
...
def chat_with_report_agent():
    ...
    The Report Agent can autonomously call retrieval tools during chat to answer questions.
...
def get_report_sections(report_id: str):
    ...
    The front-end can poll this endpoint for already-generated section content
    without having to wait for the entire report to finish.
    ...
    try:
        ...
        logger.error(f"Failed to fetch sections list: {str(e)}")
        return jsonify({
            "success": False,
            "error": str(e),
            "traceback": traceback.format_exc()
...
def check_report_status(simulation_id: str):
    ...
    Used by the front-end to decide whether to unlock the Interview feature.
    ...
    try:
        ...
        # Only unlock interview once the report is complete
...
def get_agent_log(report_id: str):
    ...
    Provides each step of the report-generation process in real time, including:
...
def stream_agent_log(report_id: str):
    """
    Get the complete Agent log (returned all at once).
...
def get_console_log(report_id: str):
    ...
    Provides the console output (INFO, WARNING, etc.) emitted during report generation.
...
def stream_console_log(report_id: str):
    """
    Get the complete console log (returned all at once).
